  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-gray-900">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section
  className="relative px-4 md:px-8 pt-40 pb-20 md:pt-48 md:pb-28 max-w-7xl mx-auto bg-gradient-to-br from-green-100 via-green-50 to-green-200 overflow-visible"
...
>
  <div className="text-center flex flex-col items-center max-w-screen-md mx-auto">
    ...
    <p className="text-lg sm:text-xl lg:text-2xl text-gray-700 max-w-2xl mb-12 leading-relaxed">
    ...
    <div className="flex flex-wrap gap-6 justify-center">
      ...
      <Link href="/login">
        ...
        {/* Features Grid */}
        <section className="px-4 py-16 bg-gray-50 dark:bg-gray-800" aria-labelledby="features-heading">
        ...
        {/* Success Metrics */}
        <section className="px-4 py-16 bg-gray-50 dark:bg-gray-800 text-center" aria-labelledby="metrics-heading">
          <div className="max-w-7xl mx-auto">
            <h2 
              id="metrics-heading"
              className="text-3xl md:text-4xl font-bold text-center text-gray-900 dark:text-white mb-12"
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/register">
                <Button
                  variant="primary"
                  size="lg"
                  className="transition-transform duration-300 hover:scale-105 hover:bg-red-600 hover:text-white"
                >
                  Start Free Trial
                </Button>
              </Link>
